      ...
      <div className="">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="flex bg-zinc-800 ml-4 items-center rounded-full pl-[10px] py-[1px] min-w-[300px] border border-gray-700 hover:drop-shadow-xl drop-shadow-zinc-800">
              <input
                type="text"
          ...
          <div className="right">
            <button className="flex items-center gap-4 border border-gray-600 px-4 py-[8px] rounded-full cursor-pointer bg-zinc-800 hover:bg-zinc-700 transition-all duration-200">
              <RiUserVoiceLine />
